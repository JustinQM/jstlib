...
size_t _varray_count(void* mem);
size_t _varray_capacity(void* mem);
size_t _varray_stride(void* mem);
...
[[maybe_unused]] size_t _varray_count(void* mem)
{
    return mem ? _varray_get_header(mem)->count : 0;
}

[[maybe_unused]] size_t _varray_capacity(void* mem)
{
    return mem ? _varray_get_header(mem)->capacity : 0;
}

[[maybe_unused]] size_t _varray_stride(void* mem)
{
